...
contract BlindAuction{
	...
	/// Modifiers are a convenient way to validate inputs ti functions. "onlyBefore" is applied
	/// to "bid" below:
	/// the new functionbody is the modifier's body there "_" is replaced by the old function body.
	...
	///The sent ether is only refunded if the bid is correctly reveales in the revealing phase.
	...
	///but still make the required deposit. The same address cam place multiple bids.
	...
	function withdraw(){
		...
		// It si important to set this to zero because the recipient can call this function again as a part of the receiving call
