...
contract Purchase{
	...
	/// The ether will be locked untill confirmReceived is called.
	...
	/// Confirm thatyou (the buyer) received the item.
	/// This will release the locked ether.
	function confirmReceived()
		onlyBuyer
		inState(State.Locked){
			itemReceived();
			//It is important to change the state first because otherwise,
			//the contracts called using "send" below
